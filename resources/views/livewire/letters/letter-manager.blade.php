                ...
                <div class="relative w-full max-w-lg bg-white rounded-t-[40px] sm:rounded-[40px] p-10 shadow-2xl">
                    ...
                    <form wire:submit="save" class="space-y-6">
                        ...
                        <div class="pt-4 flex gap-4">
                            <button type="button" @click="$set('isModalOpen', false)" class="flex-1 py-4 bg-slate-100 rounded-[24px] font-black text-xs uppercase text-slate-500">Batal</button>
