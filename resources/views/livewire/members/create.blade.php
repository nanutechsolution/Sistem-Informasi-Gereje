<div class="py-6 sm:py-12 bg-gray-50 min-h-screen">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8 border-b border-gray-200 pb-6">
            <a href="{{ route('families.edit', $family) }}" class="inline-flex items-center text-sm font-medium text-gray-500 hover:text-primary transition-colors mb-2">
                <svg class="w-5 h-5 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path></svg>
                Kembali ke KK {{ Str::limit($family->kepala_keluarga, 15) }}
            </a>
            <h1 class="text-2xl sm:text-3xl font-extrabold text-primary tracking-tight">Tambah Anggota Jemaat</h1>
            <p class="text-gray-500 mt-1">Mendaftarkan jiwa baru ke dalam keluarga <span class="font-bold text-gray-800">{{ $family->kepala_keluarga }}</span>.</p>
        </div>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        <button type="submit" wire:loading.attr="disabled" class="w-full flex justify-center py-4 px-4 border border-transparent rounded-xl shadow-lg shadow-blue-500/30 text-sm font-bold text-white bg-primary hover:bg-blue-800 focus:outline-none transition-all disabled:opacity-70">
                            <span wire:loading.remove>Simpan Anggota</span>
