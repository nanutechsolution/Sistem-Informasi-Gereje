        ...
        <div class="relative z-10 w-full flex flex-col justify-center px-16 text-white h-full">
            <div class="mb-8">
                <div class="h-16 w-16 bg-white/10 rounded-2xl flex items-center justify-center backdrop-blur-sm border border-white/20 mb-6">
                    <svg class="w-8 h-8 text-yellow-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m8-10h2m-2 4h2m-4-8h2m-2-4h2m-4 8h2m-2 4h2m-2-4h2m-2-4h2m-2 4h2m-2 4h2"></path></svg>
                </div>
        ...
        <div class="w-full max-w-md space-y-8">
            ...
            <div class="mt-6 text-center">
                <p class="text-xs text-gray-400">
                    Masalah saat login? Hubungi Administrator Multimedia GKS.
                </p>
            </div>
        </div>
    </div>
