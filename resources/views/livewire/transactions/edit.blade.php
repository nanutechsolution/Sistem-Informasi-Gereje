            ...
            <form wire:submit="update" class="p-6 sm:p-8 space-y-8">
                ...
                <div class="p-4 rounded-2xl flex items-center gap-4 border {{ $jenis == 'masuk' ? 'bg-green-50 border-green-100 text-green-800' : ($jenis == 'keluar' ? 'bg-red-50 border-red-100 text-red-800' : 'bg-blue-50 border-blue-100 text-blue-800') }}">
                    <div class="p-3 rounded-xl bg-white/50 shadow-sm">
                        @if($jenis == 'masuk') <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 14l-7 7m0 0l-7-7m7 7V3"></path>
                        </svg>
                        @elseif($jenis == 'keluar') <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="relative min-h-screen flex items-end sm:items-center justify-center p-0 sm:p-4">
                                <div class="bg-white w-full max-w-md rounded-t-3xl sm:rounded-3xl shadow-2xl overflow-hidden flex flex-col max-h-[80vh]">
                                    <div class="p-4 border-b border-gray-100 flex items-center gap-2">
                                        ...
                                        <button @click="open = false" class="p-2 bg-gray-100 rounded-xl text-gray-500 hover:bg-gray-200"><svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
                                            </svg></button>
                                    </div>
                                    <div class="overflow-y-auto p-2 space-y-1">
                ...
                <div class="pt-2">
                    <button type="submit" wire:target="update" wire:loading.attr="disabled" class="w-full flex justify-center items-center py-4 px-4 border border-transparent rounded-2xl shadow-lg text-lg font-extrabold text-white bg-primary hover:bg-blue-800 transition-all transform active:scale-[0.98] disabled:opacity-70">
